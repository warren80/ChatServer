...
**
** Created: Wed Mar 9 14:25:06 2011
...
static const char qt_meta_stringdata_Component[] = {
    "Component\0\0connectionError(const char*)\0"
    "success(const char*)\0"
};
...
int Component::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: connectionError((*reinterpret_cast< const char*(*)>(_a[1]))); break;
        case 1: success((*reinterpret_cast< const char*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void Component::connectionError(const char * _t1)
{
...
// SIGNAL 1
void Component::success(const char * _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
